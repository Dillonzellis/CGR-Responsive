<section id="banner-login" class="container u-full-width">
    ...
    <div class="four columns">
        <div class="home-banking-wrapper" style="background: #b21f17;">
            ...
            <!--login form -->
            <form class="login" target="_top" autocomplete="off" name="pgLogin" method="post"
                action="https://www.secure-cgrcu.org/Centryx/servlet/com.sos.webteller.accountaccess.DoLogin">

                <div class="tooltip">
                    <label for="memberID">Member ID</label>
                    <input type="text" name="AcctNum" placeholder="Account Number" maxlength="20" autofocus=""
                        tabindex="1" aria-label="Account Number Field" id="memberID">

                </div>
                <label for="passwordID">Password</label>
                <input name="Pin" value="" maxlength="20" placeholder="Password" tabindex="2" type="password"
                    aria-label="Password Field" autocomplete="current-password" id="passwordID">
                <input value="Login" name="btnOK" class="account2" tabindex="3" type="submit" aria-label="Login">
                <input name="txPin" value="" type="hidden">
            </form>
            <!-- end login form -->

            <p class="forgot-pass"><a id="forgotpasswordLink1" href="#"
                    onclick="postLink('https://www.secure-cgrcu.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=forgotpassword'); return false;">Forget
                    your password?</a></p>

            <button class="become-a-member" id="newMemLink1" href="#"
                onclick="postLink('https://www.secure-cgrcu.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=signup'); return false;"
                style="white-space: normal;">Enroll in Home Banking</button>
            <button class="become-a-member" id="newMemLink2" href="#"
                onclick="postLink('https://www.secure-cgrcu.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=newmem'); return false;">Become
                a Member</button>
        </div>
    </div>
        ...
        <div id="slider" class="fullwidthbanner-container">
            <div class="fullwidthbanner">
                <ul>
                    ...
                    <li data-transition="notransition" data-slotamount="10" data-masterspeed="300" data-thumb="">
                        <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                        <img src="https://www.cgrcu.org/images/slider/annual-meeting-23.jpg"
                            data-transition="notransition" alt="Annual Meeting">

                        <!-- THE CAPTIONS IN THIS SLDIE -->
                        <div class="caption" data-x="50" data-y="170" data-speed="500" data-start="1000"
                            data-easing="easeOutExpo" style="top:125px; left:50px">
                            <div
                                class="caption-wrapper-de grid gap-400 justify-center text-center clr-neutral-100 py-500 px-400">
                                <div class="fs-500 ff-primary fw-bold">Notice of Annual Meeting</div>
                                <div class="btn-wrapper"><a class="btn-de bgc-neutral-700" href="https://www.cgrcu.org/pages/annual-meeting.php">Learn More</a></div>
                            </div>
                    ...
                    <!--<li data-transition="notransition" data-slotamount="10" data-masterspeed="300" data-thumb="https://www.cgrcu.org/images/slider/annual-meeting22.jpg">
										
										<img src="https://www.cgrcu.org/images/slider/annual-meeting22.jpg" data-transition="notransition" alt="Annual Meeting">
										...
										<div class="caption large_text sfb"
											 ...
											 data-speed="500"
											 data-start="1000"
											 data-easing="easeOutExpo">CGR CU Annual Meeting<br>of the Membership<br>Tuesday, Feb. 22nd at 4:00 p.m.</div>
                    ...
                    <!--<li data-transition="notransition" data-slotamount="10" data-masterspeed="300" data-thumb="https://www.cgrcu.org/images/slider/auto-loan5.jpg">
										...
										<div class="caption large_text sfb"
											 ...
											 data-speed="500"
											 data-start="1000"
											 data-easing="easeOutExpo">Is it time for a new car?<br>No payments for up to 90 Days<br>
Rates as low as 1.74% APR</div>
